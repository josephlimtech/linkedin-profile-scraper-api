...
You should obtain a new `li_at` cookie value from the LinkedIn.com website when this error shows and update the `sessionCookieValue` with that new value. Follow the [Getting started](#getting-started) steps above in this readme.
